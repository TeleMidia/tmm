...
class MCCI {
	...
	#define MODULATION_SCHEME_DQPSK 0x00
	#define MODULATION_SCHEME_QPSK  0x01
	#define MODULATION_SCHEME_16QAM 0x02
	#define MODULATION_SCHEME_64QAM 0x03

	#define CONVOLUTIONAL_CODING_RATE_1_2 0x00
	#define CONVOLUTIONAL_CODING_RATE_2_3 0x01
	#define CONVOLUTIONAL_CODING_RATE_3_4 0x02
	#define CONVOLUTIONAL_CODING_RATE_5_6 0x03
	#define CONVOLUTIONAL_CODING_RATE_7_8 0x04
